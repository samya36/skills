...
# __file__ is in .claude/skills/nanobanana/nanobanana.py
# So we need to go up 3 levels: nanobanana -> skills -> .claude -> project_root
...
# Load with override=True to ensure values are loaded
...
if not api_key:
    raise ValueError(
        f"Missing GEMINI_API_KEY environment variable. Please check your .env file at: {env_path}"
    )
